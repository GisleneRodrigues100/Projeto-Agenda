import re #Biblioteca de procura e validação de regex
import os
import smtplib
import openpyxl
import email
    ...
    def email_destino(self):
        while True:
            ...
            if padrao_email: 
                ...
                print('Email invalido, tente outro...')

#texto/numero._@texto/numero.texto(. texto+)
    ...
    def enviar_email(self):
        ...
        msg['From'] = endereco
        msg['To'] = self.email
        msg['Sbject'] = 'Oooo zé, chegou a planilha!'
        msg.set_content(
            'Planilha em anexo.'
        )
